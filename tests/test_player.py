...
class TestPlayer(TestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(undefined_team_player.id, 2)

    def test_create_assertions(self):
        self.assertRaises(AssertionError, Player.create, name=0, team_id=1, id=2)
        self.assertRaises(AssertionError, Player.create, name="foo", team_id="bar", id=2)
        self.assertRaises(AssertionError, Player.create, name="foo", team_id=1, id="bar")
